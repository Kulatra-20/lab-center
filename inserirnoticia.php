...
<?php
		...
		else if($tipodeimg != "jpg" && $tipodeimg != "JPG" && $tipodeimg != "png" && $tipodeimg != "PNG" && $tipodeimg != "jpeg" && $tipodeimg != "JPEG" )
    {
		...
		{		
					...
					$sql = "INSERT INTO tbnoticias (titulo, descricao,data,img) VALUES ('$titulo','$texto','$data','$ficheiro')";
...
<div class="container" style="align center">
	<form action="inserirnoticia.php" method="post" enctype="multipart/form-data"/>
		Titulo:
