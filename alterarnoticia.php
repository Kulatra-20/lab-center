...
<?php
    ...
    include 'connString.php';
		 ...
		 if (isset($_GET['id_noticia']))
		{
			...
			$sql="SELECT * FROM tbnoticias WHERE id_noticia=".$id;
	...
	<?php
        ...
        if(isset($_POST['alterar']))
        {
            ...
            $caminho = "images/noticias/";
            $tipodeimg = pathinfo($ficheiro,PATHINFO_EXTENSION);

            if($ficheiro == null )
            {       
                $sql="UPDATE tbnoticias SET titulo='".$titulo."',descricao='".$texto."',data='".$data."' WHERE id_noticia=".$id;
                $con->query($sql);
            ...
            else
            {
                ...
                $sql="UPDATE tbnoticias SET titulo='".$titulo."',descricao='".$texto."', data='".$data."', img='".$ficheiro."' WHERE id_noticia=".$id;
                $con->query($sql);
                header("location:bonoticias.php");
            }
