...
<?php
    ...
    include 'connString.php';
		...
		{
			$id=$_GET['id_incubacao'];

			$sql="SELECT * FROM tbincubacao WHERE id_incubacao=".$id;
    ...
    <div class="container" style="align center">
        <form method="post" enctype="multipart/form-data">
            <input type="hidden" name="id_incubacao" value="<?php echo $row['id_incubacao']?>"/>
            <br></br>
            Titulo:
	...
	<?php
		...
		if(isset($_POST['alterar'])){
            ...
            if($ficheiro == null )
            {       
                $sql="UPDATE tbincubacao SET link='".$link."'"." WHERE id_incubacao=".$id;
                $con->query($sql);
            ...
            else
            {
                ...
                $sql="UPDATE tbincubacao SET link='".$link."',img='".$ficheiro."' WHERE id_incubacao=".$id;
                $con->query($sql);
                header("location:boincubacao.php");
            }
